...
// import { POOL_ALIASES } from '../../constants'
...
export const useNetwork = () => {
  ...
  return useMemo(
    ...
    () => getNetwork( router.query.networkName, walletChainId),
    [ router?.query?.networkName, walletChainId]
  )
}

// const getNetwork = (poolAlias, routerNetwork, walletChainId) => {
const getNetwork = ( routerNetwork, walletChainId) => {
